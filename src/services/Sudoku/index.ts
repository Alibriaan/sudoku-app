...
export class SudokuGenerator {
  ...
  private preffiledValues!: boolean[][];
    ...
    this.fillPrefilledValues();
	}

  private fillPrefilledValues() {
    this.setPreffiledValues(
      this.mat.map((rowItem, rowIndex) =>
        rowItem.map((columnItem, columnIndex) => !!columnItem
      ))
    );
  }
  ...
  public setPreffiledValues(newValue: boolean[][]) {
    this.preffiledValues = newValue;
  }

  public getPreffiledValues() {
    return this.preffiledValues;
  }
